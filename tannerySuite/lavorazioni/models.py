...
class OutputLavorazione(models.Model):
    ...
    fk_dettaglio_ordine = models.ForeignKey(DettaglioOrdineLavoro, related_name='output_lavorazione', on_delete=models.CASCADE)
    ...
    fk_taglio = models.ForeignKey(Taglio, null=True, blank=True, on_delete=models.SET_NULL, related_name='output_lavorazione')
    fk_sezione = models.ForeignKey(Sezione, null=True, blank=True, on_delete=models.SET_NULL, related_name='output_lavorazione')
    fk_concia = models.ForeignKey(Concia, null=True, blank=True, on_delete=models.SET_NULL, related_name='output_lavorazione')
    fk_tipoanimale = models.ForeignKey(TipoAnimale, null=True, blank=True, on_delete=models.SET_NULL, related_name='output_lavorazione')
    fk_spessore = models.ForeignKey(Spessore, null=True, blank=True, on_delete=models.SET_NULL, related_name='output_lavorazione')
    fk_quality = models.ForeignKey(Quality, null=True, blank=True, on_delete=models.SET_NULL, related_name='output_lavorazione')
    ...
    note = models.TextField(null=True, blank=True)
    created_by = models.ForeignKey(User, related_name='output_lavorazione', null=True, blank=True, on_delete=models.SET_NULL)
    created_at = models.DateTimeField(auto_now_add=True)
